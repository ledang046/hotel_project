   ...
   <!-- box search -->
             <div  style="justify-content: left;position: absolute; ">
              ...
              <label>Price from:</label>
                <input type="number" style="width:110px; margin-right: 20px; height:30px; border:none;outline: none;" min="0" value="0" id="fromPrice"  />
             
               <label>To:</label> 
                <input type="number" style="width:110px; height:30px;  border:none;outline: none" min="0" value="0" id="toPrice" />
            
          <button class="btn-warning" style=";border:none;border-radius: 20px" type="button"onclick="location.href = 'index.php?controller=search&fromPrice=' + document.getElementById('fromPrice').value + '&toPrice=' + document.getElementById('toPrice').value;"/><i class="fas fa-search"></i></button> 
           
          </div>
          <!-- end box search -->
      <div class="sort-box" style="text-align:right;">
               <select style="width: 120px; border-radius:20px;margin-left:1000px;"class="form-control" onchange="location.href = 'index.php?controller=products&action=category1&order='+this.value;">
