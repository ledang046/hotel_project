<?php 
 ...
 <div class="product container d-block justify-content-center">
		<div class="row d-block justify-content-center pb-4">
			...
			<h2>Suite price from <?php echo $fromPrice; ?>đ to <?php echo $toPrice; ?>đ</h2>
			</div> 
			 <!-- box search -->
      ...
      <div class="sort-box" style="text-align:right;">
               <select style="width: 120px; border-radius: 20px;margin-left:1000px" class="form-control" onchange="location.href = 'index.php?controller=search&order='+this.value;">
...
<div class="card mb-5 mt-3" style="width:18rem;">
  ...
  <div class="card-body">
    <h5 class="card-title products"><a href="index.php?controller=products&action=detail&id=<?php echo $rows->id; ?>"><?php echo $rows->name; ?></a></h5>
      ...
      <a class="page-link" href="#" aria-label="Previous">
        ...
        <span class="sr-only">Previous</span>
                  ...
                  <?php for($i = 1; $i <= $numPage; $i++): ?>
                    <li class="page-item"><a class="page-link" href="iindex.php?controller=search&action=index<?php echo $search; ?>&p=<?php echo $p; ?>"><?php echo $i; ?></a>
                    </li>
                  <?php endfor; ?>
