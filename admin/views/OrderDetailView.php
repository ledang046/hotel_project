...
<div class="col-md-12">
  ...
  <div class="panel panel-primary" style="border-color: #d1ae50;">
        <div class="panel-heading" style="background-color:#d1ae50;border-color: #d1ae50;">Order detail</div>
        <div class="panel-body">
            ...
            <table class="table">
                ...
                <tr>
                    <th style="width: 120px;">Ngày check in</th>
                     <?php foreach($data as $rows): ?>
                    <td><?php echo $rows->checkin; ?></td>
                      <?php endforeach; ?>
                </tr>
                <tr>
                    <th style="width: 120px;">Ngày check out</th>
                    <?php foreach($data as $rows): ?>
