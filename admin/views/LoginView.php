					...
					<div class="wrap d-md-flex">
						<div class="text-wrap p-4 p-lg-5 text-center d-flex align-items-center order-md-last">
							<div class="text w-100">
								...
								<a href="index.php?controller=users&action=create" class="btn btn-white btn-outline-white">Sign Up</a>
							</div>
			      </div>
			      	...
			      	<div class="d-flex">
			      		<div class="w-100">
							...
							<form method="post" action="index.php?controller=login&action=login" class="signin-form">
